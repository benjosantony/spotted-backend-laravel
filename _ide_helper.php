...
namespace {
    ...
    class Laracurl extends \Mattbrown\Laracurl\Facades\Laracurl{
        ...
        public static function getAllowedMethods(){
            return \Mattbrown\Laracurl\Laracurl::getAllowedMethods();
        }
        ...
        public static function setRequestClass($class){
            return \Mattbrown\Laracurl\Laracurl::setRequestClass($class);
        }
        ...
        public static function setResponseClass($class){
            return \Mattbrown\Laracurl\Laracurl::setResponseClass($class);
        }
        ...
        public static function buildUrl($url, $query){
            return \Mattbrown\Laracurl\Laracurl::buildUrl($url, $query);
        }
         ...
         * @static 
         */
        public static function newRequest($method, $url, $data = array(), $encoding = 0){
            return \Mattbrown\Laracurl\Laracurl::newRequest($method, $url, $data, $encoding);
        }
         ...
         * @static 
         */
        public static function newJsonRequest($method, $url, $data = array()){
            return \Mattbrown\Laracurl\Laracurl::newJsonRequest($method, $url, $data);
        }
         ...
         * @static 
         */
        public static function newRawRequest($method, $url, $data = ''){
            return \Mattbrown\Laracurl\Laracurl::newRawRequest($method, $url, $data);
        }
        
        /**
         * Prepare the curl resource for sending a request.
         *
         * @param \Mattbrown\Laracurl\Request $request
         * @return void 
         * @static 
         */
        public static function prepareRequest($request){
            \Mattbrown\Laracurl\Laracurl::prepareRequest($request);
        }
         ...
         *
         * @param \Mattbrown\Laracurl\Request $request
         * @return \Mattbrown\Laracurl\Response 
         * @static 
         */
        public static function sendRequest($request){
            return \Mattbrown\Laracurl\Laracurl::sendRequest($request);
        }
